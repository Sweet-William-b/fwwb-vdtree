...
def _build_runtime_payload(
    *,
    ...
    summary = {
        ...
        "roc_auc": backend_result.metrics.get("roc_auc"),
        "pr_auc": backend_result.metrics.get("pr_auc"),
        "pos_mean": backend_result.metrics.get("1_mean"),
        "neg_mean": backend_result.metrics.get("0_mean"),
